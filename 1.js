...
{    
    ...
    fetch(`https://65d84816c96fbb24c1bb2234.mockapi.io/movies`,{
        ...
        body:JSON.stringify({avatar:imgaddress,movietitle:title,moviereleasedate:date,
          moviedescription:description,movieratings:ratings,trailerlink:trailerlink1,actors:actors1,director:director1,casts:arr1,plot:plot1,duration:duration1,slide:arr1}),
        headers:{
                ...
                var matchedmovies;
                    ...
                    .then(movies=>{
                       ...
                       return matchedmovies;    
                              ...
                              <div class="col-md-6" style="width: 40rem; height: 40rem">
                                <div class="swiper mySwiper">
                                  <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="${matchedmovies.slide[0]}" height="100%" width="100%"></div>
                                    <div class="swiper-slide"><img src="${matchedmovies.slide[1]}" height="100%" width="100%"></div>
                                    <div class="swiper-slide"><img src="${matchedmovies.slide[2]}" height="100%" width="100%"></div>
